...
SELECT count(*) AS accounts_count FROM (
    SELECT A.account_id, B.stream_date from subscriptions A LEFT JOIN streams B 
    ON A.account_id = B.account_id AND B.stream_date  BETWEEN '2021-02-01' AND '2021-12-31' 
    WHERE end_date BETWEEN '2021-02-01' AND '2021-12-31' 
) A 
WHERE stream_date IS NULL