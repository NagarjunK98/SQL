...
SELECT DISTINCT A.user_id FROM confirmation A INNER JOIN confirmation B ON A.user_id = B.user_id 
AND A.time_stamp < B.time_stamp AND DATEDIFF(second, A.time_stamp, B.time_stamp) <= 86400